...
# Initialize ClearML
task = Task.init(
    project_name="test", #"YOLO11n training",
...
params = {
    ...
    "lr0": 0.015,
    "weight_decay": 0.0011857154513863655,
    "momentum": 0.9618693440529782,
    "warmup_momentum": 0.6549400698749953,
    "warmup_epochs": 2,
    "lrf": 0.10493019514002894,
    "cos_lr": True,
}
